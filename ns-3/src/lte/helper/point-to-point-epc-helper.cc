  ...
  : m_gtpuUdpPort (2152)  // fixed by the standard
{
  ...
  /*
   * Create CSON interface
   * */
  m_cson = CreateObject<EpcMmeCSON>();
  m_cson->SetEpcMmeCSONSapProvider(m_mme->GetEpcMmeCSONSapProvider());
  m_mme->SetEpcMmeCSONSapUser(m_cson->GetEpcMmeCSONSapUser());
}
