...
//    uint64_t			imsi;
  ...
  struct RlfIndicationMessageParams
  {//THANG
      uint16_t failureCellId;
      uint16_t failureCRNTI;
      uint64_t failureIMSI;
      uint16_t reportCellId;
      uint16_t sourceCellId;
      uint64_t newTeId; //suggest
      bool     forwarded;
      std::list<LteRrcSap::MeasResultEutra> rlfMeasData;
  };
...
public:
  ...
  /**************THANG**************/
  virtual void SendRlfIndicationMessage (RlfIndicationMessageParams params) = 0;
  /*********************************/
};
...
public:
  ...
  /*****************THANG****************/
  virtual void RecvRlfIndicationMessage (RlfIndicationMessageParams params) = 0;
  /**************************************/
};
...
public:
  ...
  /******************THANG*****************/
  virtual void SendRlfIndicationMessage (RlfIndicationMessageParams params);
  /****************************************/
private:
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendRlfIndicationMessage (RlfIndicationMessageParams params){
    m_x2->DoSendRlfIndicationMessage(params);
}
/*****************************************/
///////////////////////////////////////
...
public:
  ...
  /****************THANG*****************/
  virtual void RecvRlfIndicationMessage (RlfIndicationMessageParams params);
  /**************************************/
private:
...
template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvRlfIndicationMessage (RlfIndicationMessageParams params){
	m_rrc->DoRecvRlfIndicationMessage(params); //RRC layer receives this message
}
/************************************/
} // namespace ns3
