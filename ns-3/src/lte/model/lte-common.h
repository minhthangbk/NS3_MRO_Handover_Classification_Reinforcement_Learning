...
public:
   ...
   */
    ...
    static double IeValue2ActualCIO(int8_t cioValue);

    static int8_t ActualCIOIeValue (double cioValue);

    static double IeValue2ActualCIONew(double cioValue);

    static double ActualCIOIeValueNew (double cioValue);
