...
TypeId LteEnbNetDevice::GetTypeId (void)
{
  static TypeId
    ...
    /*
     * Developed by THANG
     * implement DSON entity attribute for Net Device Object
     */
   .AddAttribute ("LteEnbDSON",
					  "The DSON associated to this EnbNetDevice",
					  PointerValue (),
					  MakePointerAccessor (&LteEnbNetDevice::m_dson),
					  MakePointerChecker <LteEnbDSON> ())
