...
public:
    ...
    std::map<uint8_t, uint32_t> GetTeIdByBearerIdMap(); //THANG
    void UpdateTeIdBIDMap(uint8_t bid, uint32_t teid);//THANG
    EpcTftClassifier GetEpcTftClassifier();//THANG
    void ClearTftClassifier(); //THANG
    /** 
