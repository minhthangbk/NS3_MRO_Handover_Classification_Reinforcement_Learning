...
public:
  ...
  //THANG adds to identifies which is base station
  uint64_t GetCellId();
  /**
  ...
  //THANG adds for island configuration
  void SetRemIslands(std::map< uint64_t, std::list< Ptr<IsLandProfile> > > islandList);
