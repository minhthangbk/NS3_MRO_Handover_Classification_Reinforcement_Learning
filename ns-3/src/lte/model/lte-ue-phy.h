...
/*
 * THANG add outofsync/insync
 */
  void SetQinsync(double q);
  double GetQinsync() const;
  void SetQoutofsync(double q);
  double GetQoutofsync() const;
  /**
...
//Fixed parameters
//double m_cellload;
//double m_SINRinsync; //db
//double m_SINRoutofsync;
double m_RSRQinsync;
double m_RSRQoutofsync;
bool m_outofsyncFlag;
uint64_t m_imsi;
uint8_t m_rat;
//void TraceAllDetectedCells(LteUeCphySapUser::UeMeasurementsParameters newMeasurement);
//bool m_firstWriteNewMeasurement;
/***********************************************************************************/
