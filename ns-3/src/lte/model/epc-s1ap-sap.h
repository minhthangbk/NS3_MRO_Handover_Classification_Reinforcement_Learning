...
#include <list>
#include <map>
#include "son-common.h" //Add by THANG
namespace ns3 {
...
public:
   ...
   * SON API SON
   */
  virtual void EnbS1apSendPMReportNotifyMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::PerformanceReport pmReport)=0;
  virtual void EnbS1ApSendDSONParamRespMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList) = 0;
}; //End EpcS1apSapMme
...
public:
  ...
  /*
   * dev by THANG
   * Mme Send new parameters value to CSON
   */
  virtual void MmeSendUpdateParamConfigEnbS1ap(SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList) = 0;
  /*
   * Mme Send Parameters Updated Request to Each eNB
   */
  virtual void MmeSendDSONParamReqEnbS1ap(SONCommon::SONMsgInfo msgInfo) = 0;
...
public:
   ...
   * Developed by THANG
   */
  virtual void EnbS1apSendPMReportNotifyMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::PerformanceReport pmReport);
  virtual void EnbS1ApSendDSONParamRespMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList);
private:
  MemberEpcS1apSapMme ();
  C* m_owner;
};
 ...
 */
template <class C>
void MemberEpcS1apSapMme<C>::EnbS1apSendPMReportNotifyMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::PerformanceReport pmReport){
	m_owner->MmeRcvPMReportNotify(cellId,msgInfo,pmReport);
}
template <class C>
void MemberEpcS1apSapMme<C>::EnbS1ApSendDSONParamRespMme(uint16_t cellId, SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList){
	m_owner->MmeRecvDSONParamResp(cellId,msgInfo,paramList);
}
...
public:
   ...
   * Dev by THANG
   */
  virtual void MmeSendUpdateParamConfigEnbS1ap(SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList);
  virtual void MmeSendDSONParamReqEnbS1ap(SONCommon::SONMsgInfo msgInfo);
private:
  MemberEpcS1apSapEnb ();
  C* m_owner;
};
...
template <class C>
void MemberEpcS1apSapEnb<C>::MmeSendUpdateParamConfigEnbS1ap (SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList){
  m_owner->EnbS1apRecvUpdateParamConfig (msgInfo, paramList);
}

template <class C>
void MemberEpcS1apSapEnb<C>::MmeSendDSONParamReqEnbS1ap (SONCommon::SONMsgInfo msgInfo){
  m_owner->EnbS1apRecvDSONParamReq (msgInfo);
}
