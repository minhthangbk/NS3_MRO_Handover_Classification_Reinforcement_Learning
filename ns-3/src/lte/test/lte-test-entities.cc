...
/*
 * Add by THANG (for compiling)
 */
void
EpcTestRrc::EnbS1apRecvUpdateParamConfig(SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList){

}

void
EpcTestRrc::EnbRrcRecvUpdateParamConfig(SONCommon::SONMsgInfo msgInfo, SONCommon::SONParamList paramList){

}

void
EpcTestRrc::EnbRrcRecvDSONParamReq(SONCommon::SONMsgInfo msgInfo){
