...
def register_types(module):
    ...
    module.add_container('std::map< unsigned int, ns3::Ptr< ns3::Object > >', ('unsigned int', 'ns3::Ptr< ns3::Object >'), container_type=u'map')
...
def register_Ns3ObjectPtrContainerValue_methods(root_module, cls):
    ...
    cls.add_method('GetN', 
                   ...
                   [], 
                   is_const=True)
    ## object-ptr-container.h (module 'core'): std::map<unsigned int, ns3::Ptr<ns3::Object>, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, ns3::Ptr<ns3::Object> > > > ns3::ObjectPtrContainerValue::GetObjects() [member function]
    cls.add_method('GetObjects', 
                   'std::map< unsigned int, ns3::Ptr< ns3::Object > >', 
                   [])
    ...
    cls.add_method('SerializeToString', 
                   ...
                   [param('ns3::Ptr< ns3::AttributeChecker const >', 'checker')], 
                   is_const=True, is_virtual=True)
    ## object-ptr-container.h (module 'core'): void ns3::ObjectPtrContainerValue::SetObjects(std::map<unsigned int, ns3::Ptr<ns3::Object>, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, ns3::Ptr<ns3::Object> > > > value) [member function]
    cls.add_method('SetObjects', 
                   'void', 
                   [param('std::map< unsigned int, ns3::Ptr< ns3::Object > >', 'value')])
    return
