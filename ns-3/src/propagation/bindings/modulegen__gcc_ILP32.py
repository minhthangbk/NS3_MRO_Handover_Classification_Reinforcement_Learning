...
def register_types(module):
    ...
    ## pathloss-model-etri.h (module 'propagation'): ns3::PathlossModelETRI [class]
    module.add_class('PathlossModelETRI', parent=root_module['ns3::PropagationLossModel'])
...
def register_methods(root_module):
    ...
    register_Ns3PathlossModelETRI_methods(root_module, root_module['ns3::PathlossModelETRI'])
...
def register_Ns3PropagationLossModel_methods(root_module, cls):
    ## propagation-loss-model.h (module 'propagation'): ns3::PropagationLossModel::m_rxPower [variable]
    cls.add_instance_attribute('m_rxPower', 'double', is_const=False)
    ...
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## propagation-loss-model.h (module 'propagation'): double ns3::PropagationLossModel::GetRxPower() [member function]
    cls.add_method('GetRxPower', 
                   'double', 
                   [])
...
def register_Ns3PathlossModelETRI_methods(root_module, cls):
    ## pathloss-model-etri.h (module 'propagation'): static ns3::TypeId ns3::PathlossModelETRI::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## pathloss-model-etri.h (module 'propagation'): ns3::PathlossModelETRI::PathlossModelETRI() [constructor]
    cls.add_constructor([])
    ## pathloss-model-etri.h (module 'propagation'): double ns3::PathlossModelETRI::GetLoss(ns3::Ptr<ns3::MobilityModel> a, ns3::Ptr<ns3::MobilityModel> b) const [member function]
    cls.add_method('GetLoss', 
                   'double', 
                   [param('ns3::Ptr< ns3::MobilityModel >', 'a'), param('ns3::Ptr< ns3::MobilityModel >', 'b')], 
                   is_const=True)
    ## pathloss-model-etri.h (module 'propagation'): double ns3::PathlossModelETRI::GetShadowing() const [member function]
    cls.add_method('GetShadowing', 
                   'double', 
                   [], 
                   is_const=True)
    ## pathloss-model-etri.h (module 'propagation'): void ns3::PathlossModelETRI::SetShadowing(double shadowing) [member function]
    cls.add_method('SetShadowing', 
                   'void', 
                   [param('double', 'shadowing')])
    ## pathloss-model-etri.h (module 'propagation'): double ns3::PathlossModelETRI::DoCalcRxPower(double txPowerDbm, ns3::Ptr<ns3::MobilityModel> a, ns3::Ptr<ns3::MobilityModel> b) const [member function]
    cls.add_method('DoCalcRxPower', 
                   'double', 
                   [param('double', 'txPowerDbm'), param('ns3::Ptr< ns3::MobilityModel >', 'a'), param('ns3::Ptr< ns3::MobilityModel >', 'b')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## pathloss-model-etri.h (module 'propagation'): int64_t ns3::PathlossModelETRI::DoAssignStreams(int64_t stream) [member function]
    cls.add_method('DoAssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')], 
                   visibility='private', is_virtual=True)
