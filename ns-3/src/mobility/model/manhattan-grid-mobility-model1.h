/*
 * manhattan-grid-mobility-model2.h
 *
 *  Created on: Sep 12, 2017
 *      Author: thang
 */

#ifndef MANHATTAN_GRID_MOBILITY_MODEL2_H_
#define MANHATTAN_GRID_MOBILITY_MODEL2_H_
...
class ManhattanGridMobilityModel1 : public MobilityModel
{
public:
	static TypeId GetTypeId (void);
	ManhattanGridMobilityModel1 ();
protected:
...
#endif /* MANHATTAN_GRID_MOBILITY_MODEL2_H_ */
