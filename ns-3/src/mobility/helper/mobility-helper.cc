...
void 
MobilityHelper::SetMobilityModelExt1(std::string type, //THANG
		std::string n1, const AttributeValue &v1,
		std::string n2, const AttributeValue &v2,
		std::string n3, const AttributeValue &v3,
		std::string n4, const AttributeValue &v4,
		...
		std::string n10, const AttributeValue &v10)
{
	...
	m_mobility.Set (n8, v8);
	m_mobility.Set (n9, v9);
	m_mobility.Set (n10, v10);
}

void
MobilityHelper::SetMobilityModelExt2(std::string type,
		std::string n1, const AttributeValue &v1,
		std::string n2, const AttributeValue &v2,
		std::string n3, const AttributeValue &v3,
		std::string n4, const AttributeValue &v4,
		...
		std::string n11, const AttributeValue &v11)
{
	...
	m_mobility.Set (n9, v9);
	m_mobility.Set (n10, v10);
	m_mobility.Set (n11, v11);
}

void
MobilityHelper::SetMobilityModelExt3(std::string type,
		std::string n1, const AttributeValue &v1,
		std::string n2, const AttributeValue &v2,
		std::string n3, const AttributeValue &v3,
		std::string n4, const AttributeValue &v4,
